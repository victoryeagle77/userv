...
the detected network interface type (Ethernet, Wifi, Cellular, InfiniBand),
running on a IT equipment, based on a defined ratio in GB/Wh.
...
$$
E_{\text{transferred}} = \frac{D_{\text{rx}} + D_{\text{tx}}}{1000} \times R_{\text{interface}} \times R_{\text{traffic}}
$$
